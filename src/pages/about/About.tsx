            ...
            >
                <div className="flex flex-col md:flex-row gap-8 relative">
                    <div className="flex flex-col justify-center max-w-3xl space-y-4 md:space-y-5 order-2 md:order-1">
                        ...
                        <motion.h2
                            className="text-3xl md:text-5xl font-serif mb-4 md:mb-8"
                            variants={itemVariants}
                        >
                            Betta splendens
                    ...
                    <div className="md:w-1/2 relative flex justify-center md:justify-end mb-6 md:mb-0 order-1 md:order-2">
                        <motion.img
                            src="/betta-white.jpg"
                            alt="Betta splendens"
                ...
                >
                    <div className="flex flex-col items-center cursor-pointer">
                        <p className="text-sm uppercase mb-2">Ver mais</p>
                        <ArrowDown className="w-6 h-6 text-white" />
                    </div>
                </motion.div>
            </motion.div>
